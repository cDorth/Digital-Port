...
def projects():
    ...
    return render_template('portfolio/projects.html', projects=projects, 
                         categories=categories, current_category=category_id, search_form=search_form)
...
def about():
    ...
    return render_template('portfolio/about.html', about_me=about_me, search_form=search_form)
